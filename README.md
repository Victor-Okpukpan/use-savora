...
| **Extensions** | On a `Completed` circle the creator can `propose_extension`; it seals only when every live member opts in. Declining is `close_position` — deposit refunded, membership permanently ended. |
